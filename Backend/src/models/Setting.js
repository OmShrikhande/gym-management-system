...
const brandingSettingsSchema = new mongoose.Schema({
  ...
  backgroundColor: { type: String, default: '#111827' }, // Default dark background
  sidebarColor: { type: String, default: '#1F2937' },    // Default sidebar color
  cardColor: { type: String, default: '#1F2937' },       // Default card background
  textColor: { type: String, default: '#FFFFFF' },       // Default text color
